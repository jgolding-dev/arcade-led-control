...
void Player2::setup() {
  ...
  FastLED.addLeds<JOYSTICK_RING_LED_TYPE, PLAYER2_JOYSTICK_DATA_PIN, JOYSTICK_RING_LED_COLOR_ORDER>(_joystickLeds, 0, JOYSTICK_RING_LED_COUNT);
  ...
  FastLED.addLeds<JOYSTICK_BALLTOP_LED_TYPE, PLAYER2_JOYSTICK_DATA_PIN, JOYSTICK_BALLTOP_LED_COLOR_ORDER>(_balltopLeds, JOYSTICK_RING_LED_COUNT, JOYSTICK_BALLTOP_LED_COUNT);
}
