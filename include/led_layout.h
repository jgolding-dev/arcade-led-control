...
#define JOYSTICK_RING_LED_TYPE            WS2812B
#define JOYSTICK_BALLTOP_LED_TYPE         WS2812B
#define OPTIONS_BUTTONS_LED_TYPE          WS2812B

// -------- LED Color Order -------- //'
#define ACCENT_LED_COLOR_ORDER            GRB
#define ACTION_BUTTONS_LED_COLOR_ORDER    GRB
#define JOYSTICK_RING_LED_COLOR_ORDER     GRB
#define JOYSTICK_BALLTOP_LED_COLOR_ORDER  RGB
